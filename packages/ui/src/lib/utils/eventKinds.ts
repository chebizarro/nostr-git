...
export function getEventKindDescription(kind: number): string {
  switch (kind) {
    ...
    case 1617: return 'Git Patch';
    case 1621: return 'Git Issue';
    case 1623: return 'Git Comment';
    case 1630: return 'Issue Status Change';
    case 1631: return 'Patch Status Change';
    case 1632: return 'Repository Status Change';
    case 1633: return 'General Status Change';
    ...
    case 30617: return 'Git Repository';
    case 30618: return 'Git Repository State';
    default: return `Unknown Event Kind ${kind}`;
  }
}
