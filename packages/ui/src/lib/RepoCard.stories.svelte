<script module>
  ...
  const { Story } = defineMeta({
    ...
    argTypes: {
      ...
      owner: {
        control: 'object',
        defaultValue: { name: 'Alice', avatar: 'https://i.pravatar.cc/40?u=alice', email: 'alice@example.com' },
      },
    ...
    args: {
      ...
      owner: { name: 'Alice', avatar: 'https://i.pravatar.cc/40?u=alice', email: 'alice@example.com' },
      issueCount: 0,
...
<Story name="Stale Repo">
  <RepoCard
    ...
    owner={{ name: 'Carol', avatar: 'https://i.pravatar.cc/40?u=carol', email: 'carol@example.com' }}
    issueCount={0}
