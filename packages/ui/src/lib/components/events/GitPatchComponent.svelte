<script lang="ts">
  ...
  import { GitPullRequest, Copy, ChevronDown, ChevronUp, BookmarkPlus, BookmarkCheck, FileCode, Shield } from '@lucide/svelte';
    ...
    <div class="flex-1">
      ...
      {:else}
        <div class="bg-muted/30 p-3 rounded border text-sm mb-3">
          <pre class="whitespace-pre-wrap overflow-x-auto max-h-48 overflow-y-auto">{patchContent}</pre>
        </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex gap-2">
          <Button variant="outline" size="sm" class="h-8 px-3 py-0 text-xs">
            View Diff
          </Button>
